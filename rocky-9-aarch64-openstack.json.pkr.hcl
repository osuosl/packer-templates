...
source "qemu" "rocky-9" {
  ...
  boot_command      = [
    ...
    "inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/rocky-9/ks-aarch64.cfg",
  ...
  headless          = true
  http_directory    = "http"
  iso_checksum      = "file:${var.mirror}/pub/rocky/9/isos/aarch64/CHECKSUM"
  iso_url           = "${var.mirror}/pub/rocky/9/isos/aarch64/Rocky-9-latest-aarch64-minimal.iso"
