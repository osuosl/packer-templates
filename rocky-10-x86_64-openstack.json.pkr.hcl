...
source "qemu" "rocky-10" {
  ...
  boot_command      = [
    ...
    "inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/rocky-10/ks-x86_64.cfg",
  ...
  headless          = true
  http_directory    = "http"
  iso_checksum      = "file:${var.mirror}/pub/rocky/10/isos/x86_64/CHECKSUM"
  iso_url           = "${var.mirror}/pub/rocky/10/isos/x86_64/Rocky-10-latest-x86_64-minimal.iso"
  memory            = 2048
