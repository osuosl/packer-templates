...
source "qemu" "centos-stream-9" {
  ...
  headless         = true
  http_directory   = "http"
  iso_checksum     = "file:${var.mirror}/9-stream/BaseOS/ppc64le/iso/CentOS-Stream-9-latest-ppc64le-dvd1.iso.SHA256SUM"
  iso_url          = "${var.mirror}/9-stream/BaseOS/ppc64le/iso/CentOS-Stream-9-latest-ppc64le-dvd1.iso"
